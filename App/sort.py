...
api_url = f"https://api.github.com/search/repositories?q=language:python+stars:%3E=100000+forks:%3E=30&page=1&per_page=3"
...
for s in data["items"]:
    ...
    while i < len(list_search):
        ...
        CC_avg = CC_avg + CC
        total_lines += lines
        table.add_row([code.filename, CC, lines, total_lines])
